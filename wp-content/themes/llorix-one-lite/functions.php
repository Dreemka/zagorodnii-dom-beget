...
llorix_one_lite_themeisle_sdk();

function register_scripts() {
    wp_register_script('slick', get_bloginfo("template_url").'/js/slick.js', '1.0.0', 1);
    wp_register_script('fancybox', get_bloginfo("template_url").'/js/jquery.fancybox.js', '1.0.0', 1);
    wp_register_script('custom', get_bloginfo("template_url").'/js/custom.js', '1.0.0', 1);
