...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/wp-content/themes/llorix-one-lite/css/slick.css" />
	<link rel="stylesheet" type="text/css" href="/wp-content/themes/llorix-one-lite/css/slick-theme.css" />
	<link rel="stylesheet" type="text/css" href="/wp-content/themes/llorix-one-lite/css/jquery.fancybox.css" />
		...
		<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation appear-on-scroll">
			...
			if ( isset( $llorix_one_lite_very_top_header_show ) && $llorix_one_lite_very_top_header_show != 1 ) {
				...
				<div class="very-top-header llorix_one_lite_only_customizer" id="very-top-header">
					<div class="container">
					<?php //echo do_shortcode('[fm_list_city]'); ?>
						<?php
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					if ( ! empty( $llorix_one_lite_logo ) ) :
						...
						echo '<h1 itemprop="headline" id="site-title" class="site-title"><a href="' . esc_url( home_url( '/' ) ) . '" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" rel="home">' . do_shortcode(get_bloginfo( 'name' )) . '</a></h1>';

						echo '<p itemprop="description" id="site-description"  class="site-description">' . do_shortcode(get_bloginfo( 'description' )) . '</p>';
